...
interface SubjectMdOverlayProps {
    content: string;
    subjectName: string;
    isOpen: boolean;
    onClose: () => void;
...
export default function SubjectMdOverlay({ content, subjectName, isOpen, onClose }: SubjectMdOverlayProps) {
    return (
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-6 md:px-10 py-6 border-b border-[#C9A063]/20 relative z-10 bg-[#1a1a1a]">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="font-display text-xl text-[#E8E6DC]">
                                    {subjectName}
                                </span>
                            </div>
                                ...
                                <div className="max-w-4xl mx-auto">
                                    {content ? (
                                        ...
                                        <div className="flex flex-col items-center justify-center h-64 border border-dashed border-[#C9A063]/20 bg-[#C9A063]/5">
                                            <p className="font-mono text-[#C9A063] text-lg mb-2">NO_CONTENT_FOUND</p>
                                            <p className="text-[#C9A063]/50 text-sm">无法加载主题导读内容</p>
                                        </div>
                                    )}
                                </div>
